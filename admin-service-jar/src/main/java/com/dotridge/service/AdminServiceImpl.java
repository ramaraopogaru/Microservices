...
import com.dotridge.proxy.HospitalProxy;

@Service
public class AdminServiceImpl implements AdminService 
{
	/*@Autowired
	private HospitalFeignClient hospFeign;*/
		...
		public Admin mapBeanToDomain(AdminBean adminBean) 
	{
		...
		/*ResponseEntity<String> resp = hospFeign.getHospitalByName(adminBean.getHospitalName());
		String hospitalInfo = resp.getBody();
		*/
		admin.setHospitalInfo(HospitalProxy.getHospitalInfoByName(adminBean.getHospitalName()));
	...
	public AdminBean mapDomainToBean(Admin admin) 
	{
		...
		adminBean.setHospitalName(admin.getHospitalInfo());
