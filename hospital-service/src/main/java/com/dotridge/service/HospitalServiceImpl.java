...
public class HospitalServiceImpl implements HospitalService 
{
	...
	public HospitalBean getHospitalByName(String hospitalName) 
	{
		...
		Hospital hospital = hospitalDao.getHospitalByUniqueName(hospitalName);
		System.out.println("hospital service is:\t"+hospital.toString());
		HospitalBean hospitalBean = mapDomainToBean(hospital);
		return hospitalBean;
	}
